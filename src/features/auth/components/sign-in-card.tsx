...
/* ─── Precision reticle – ultra-thin monochrome ─────────────── */
...
const DartIcon = () => (
  <svg viewBox="0 0 22 22" fill="none" style={{ width: 20, height: 20 }}>
    <line x1="3"  y1="19" x2="14" y2="8"  stroke="white" strokeWidth="1.3" strokeLinecap="round" />
    <line x1="14" y1="8"  x2="19" y2="3"  stroke="white" strokeWidth="1.6" strokeLinecap="round" />
    <path d="M18 3 L21 0 L20 4.5 Z"        stroke="white" strokeWidth="0.7" fill="rgba(255,255,255,0.15)" />
    <circle cx="3.5" cy="18.5" r="2" stroke="white" strokeWidth="0.6" opacity="0.4" />
  </svg>
);
